    ...
    function paletteTemplate(p, a, b, d) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            if (f) {
                ...
                e.push($('
').append($('').attr('title', d.noColorSelectedText)).html())
            }
        }
        return "
" + e.join('') + "
...
$(document).ready(function () {
    $("#multimockup").css("display", "inline-block").html('With  by Jagoan Redesign');
    setInterval(function () {
        if (!$("#multimockup:visible").length) {
            window.location.href = "http://www.jagoanredesign.eu.org"
        }
    }, 3000)
})
